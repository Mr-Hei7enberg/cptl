...
const modal_feedback = new bootstrap.Modal('#modal_feedback');
modal_feedback.show();
...
// Show important message 13.12.2023 *****************
// window.setTimeout(function () {
//     new bootstrap.Toast(document.getElementById('toast1'), {
//         delay: 9000
//     }).show(); // Show toast

// }, 1700);
// window.setTimeout(function () {
//     new bootstrap.Toast(document.getElementById('toast2'), {
//         delay: 9000
//     }).show(); // Show toast
// }, 3400);
...
const validatorFeedback = new JustValidate('#feedback-form', {
    validateBeforeSubmitting: true,
...
validatorFeedback
    ...
    .addRequiredGroup('#rating',
        "Поле обов\'язкове",
        {
            errorMessage: "Поле обов\'язкове",
            errorsContainer: '#rating__error__container',
        })
    // .addField('#rating', [
    //     {
    //         validator: (value, fields) => {
    //             if (fields['#input-rating'] && fields['#input-rating'].elem) {
    //                 let { totalValue } = fields['#input-rating'].elem.dataset;
...
document.querySelectorAll('[data-scroll]').forEach(el => {
    el.addEventListener('click', (e) => {
        ...
        if (pathname === '/') {
            ...
            window.location.assign(`/#${getId(e.target)}`);
        }
    });
});
